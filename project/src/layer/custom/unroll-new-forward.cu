...
__global__ void matrix_unrolling_kernel(const float *input, float *output,
    ...
    */
    ...
    size_t Width_unrolled = Width_out * Height_out * Batch;
...
__host__ void GPUInterface::conv_forward_gpu(float *device_output, const float *device_input, const float *device_mask, const int Batch, const int Map_out, const int Channel, const int Height, const int Width, const int K)
{
    ...
    dim3 unroll_grid_dim((Width_unrolled - 1) / THREADS_PER_BLOCK + 1, 1, 1);
    dim3 unroll_block_dim(THREADS_PER_BLOCK, 1, 1);
    matrix_unrolling_kernel<<<unroll_grid_dim, unroll_block_dim>>>(
